      ...
      <div className="space-y-4 pb-8 text-right">
        ...
        <Card variant="elevated">
          ...
          <p className="text-[13px] text-text-secondary leading-relaxed">
            منصة "في الطريق" هي شبكة تضامنية تعتمد على الثقة المتبادلة بين
            الجيران لنقل الاحتياجات والمشاوير اليومية في الأوقات الصعبة.
          </p>
        </Card>
        ...
        <Card>
          ...
          <Card.Body>
            <ul className="text-[13px] text-text-secondary space-y-2 leading-relaxed list-disc pr-4">
              ...
              <li>
                يلتزم المسافر بنقل الأغراض بأمان وتسليمها إلى صاحب الطلب في
                الوقت المتفق عليه.
              </li>
              <li>يمنع منعاً باتاً طلب أو نقل أي مواد محظورة أو خطرة.</li>
              <li>
                التقييمات المتبادلة تبني السمعة والموثوقية للجميع داخل النظام.
              </li>
            </ul>
          </Card.Body>
        </Card>
        ...
        <Card>
          ...
          <Card.Body>
            <p className="text-[13px] text-text-secondary leading-relaxed">
              نحن نلتزم بحماية بياناتك الشخصية؛ لا يتم مشاركة رقم هاتفك إلا مع
              الطرف الآخر بعد تأكيد قبول المشوار لضمان سهولة التواصل. يتم حفظ
              بيانات الموقع والطلبات بأعلى معايير التشفير والأمان.
            </p>
          </Card.Body>
        </Card>
      </div>
